...
<head>
  ...
  <style>
    ...
    .photo-edit:hover { background-color: var(--color-hover); }
    ...
    <div class="main">
      <div class="profile-card">
        ...
        <div class="profile-photo">
          <img id="profileImg" src="https://via.placeholder.com/110" alt="Foto Profil">
          <label for="fileInput" class="photo-edit">
